...
public class ActivityAreaItem extends LinearLayout {
	...
	public ActivityAreaItem(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initData();
		initView(context);
	}

	public ActivityAreaItem(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData();
		initView(context);
	}

	public ActivityAreaItem(Context context) {
		super(context);
		initData();
		initView(context);
...
//		popupWindow.setAnimationStyle(0);
	...
	private void initView(Context context) {
		View view = View.inflate(getContext(), R.layout.item_enlarge,this);
		ll_root = (LinearLayout) view.findViewById(R.id.ll_root_area);
		ll_parent = (LinearLayout) view.findViewById(R.id.ll_parent_arem);
		iv_icon = (ImageView) view.findViewById(R.id.iv_icon);
		tv_content = (ScrollAlwaysTextView) view.findViewById(R.id.tv_content);
...
//		}
	...
	public void showPopupWindow(View item,String description){
		try {
				...
				tv_description = new TextView(getContext());
				tv_description.setTextColor(getResources().getColor(R.color.white));
				tv_description.setBackgroundResource(R.drawable.bubble_area_item);
				if(densityDPI==240){
					tv_description.setMaxWidth(300);
...
//				int h = View.MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED);
//				tv_description.measure(w, h);
//				int ww = tv_description.getMeasuredWidth();
//				LogUtils.i("ww"+ww);
				if(popupWindow==null){
					popupWindow = new PopupWindow(tv_description);
					popupWindow.setWidth(LayoutParams.WRAP_CONTENT);
